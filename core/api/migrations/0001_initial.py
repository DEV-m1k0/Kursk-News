# Generated by Django 4.2 on 2025-05-01 15:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Пользователь', 'Пользователь'), ('Копирайтер', 'Копирайтер'), ('Администратор', 'Администратор'), ('Редактор', 'Редактор')], default='user', max_length=20, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('На рассмотрении', 'На рассмотрении'), ('Утверждена', 'Утверждена'), ('Отклонена', 'Отклонена')], default='under_consideration', max_length=30, verbose_name='Статус новости')),
