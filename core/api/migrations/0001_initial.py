# Generated by Django 4.2 on 2025-04-29 13:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('reporter', 'Репотртёр'), ('admin', 'Администратор'), ('redactor', 'Редактор')], max_length=20, verbose_name='Роль')),
