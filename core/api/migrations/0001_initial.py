# Generated by Django 4.2 on 2025-04-30 18:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('copywriter', 'Копирайтер'), ('admin', 'Администратор'), ('redactor', 'Редактор')], default='user', max_length=20, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('under_consideration', 'На рассмотрении'), ('approver', 'Утверждена'), ('rejected', 'Отклонена')], default='under_consideration', max_length=30, verbose_name='Статус новости')),
